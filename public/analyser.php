...
$cheminConfig = __DIR__ . '/../config/anthropic.php';
if (!file_exists($cheminConfig)) {
    http_response_code(500);
    echo json_encode(['succes' => false, 'erreur' => "Clé API non configurée (config/anthropic.php manquant, voir config/anthropic.php.example)."]);
    exit;
}
